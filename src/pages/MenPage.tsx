...
const MenPage: React.FC = () => {
  ...
  const fetchProducts = async () => {
    const params: any = { category: 'men', subcategory: filters.subcategories.join(','), minPrice: filters.minPrice, maxPrice: filters.maxPrice, material: filters.materials.join(',') };
    try {
