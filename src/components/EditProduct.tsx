...
const EditProduct: React.FC<EditProductProps> = ({ isOpen, onClose, product, onSave }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://ecomplazza.serveftp.com/api/products/${product._id}`, {
        method: 'PUT',
        headers: {
      ...
      onSave(updatedProduct); // Call the onSave prop to update the product list
